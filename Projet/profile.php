			      		...
			      		<div class="col-12 col-md-8 col-lg-6 col-xl-5">
			        		<div class="card bg-light text-black" style="border-radius: 1rem;">
			          			<div class="card-body p-5 text-center">
			            			...
			            			<button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg px-5" name="dataPassword" id="dataPassword" form="dataProfile" type="submit" value="ChangePwd">Changer le mot de passe</button><br><br>
